...
{
    public static class LicenceCryption
    {
        ...
        public static string Encryption(this string data, string secretKey)
        {
            var sKey = secretKey.HexStr2ByteArray();
            var r = new Random();
            var key = new byte[16];
            r.NextBytes(key);
        ...
        public static string Decryption(this string data, string secretKey)
        {
            var sKey = secretKey.HexStr2ByteArray();
